...
CORE_PEER_MSPCONFIGPATH=/peers/repairServicePeer/localMspConfig CORE_PEER_ADDRESS=repairservice-peer:7051 CORE_PEER_LOCALMSPID=RepairServiceOrgMSP peer channel join -b default.block